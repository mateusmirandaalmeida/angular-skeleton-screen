function Placeload$1852(containerEl$1853, options$1854) {
	...
	*/
    ...
    if (typeof document.querySelector(this.container + ' .skeleton-screen-placeload-background') !== 'undefined' && document.querySelector(this.container + ' .skeleton-screen-placeload-background') === null) {
        animateContentEl$1912 = addClass$1878('skeleton-screen-placeload-background')(appendIn$1888(document.querySelector(this.container))(document.createElement('div')));
    } else {
        animateContentEl$1912 = document.querySelector(this.container + ' > ' + '.skeleton-screen-placeload-background');
    }
    var animateContentX$1917 = animateContentEl$1912.offsetWidth;
    if (/******** Customize background ********/
        backOptions$1856.borderRadius !== '') {
        var containerBackground$1941 = document.querySelector(this.container + ' .skeleton-screen-placeload-background');
